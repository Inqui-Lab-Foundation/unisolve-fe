                ...
                <Col md={6}>
                    ...
                    >
                        <g id="Plan_x0020_1">
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === ''
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'thiruchirapalli'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'nagapattinam'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                ...
                                className={`fil0 str0 ${
                                    addClassName.id &&
                                    addClassName.id === 'thiruvannamalai'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'tiruppur'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'karur'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'theni'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'madurai'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'dindigul'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'the nilgiris'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'coimbatore'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'ramanathapuram'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'sivaganga'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'pudukkottai'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'tenkasi'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'thoothukudi'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'virudhunagar'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'kanniyakumari'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
                            ...
                            <path
                                className={`fil0 str0 ${
                                    addClassName.id && addClassName.id === 'tirunelveli'
                                        ? addClassName.districtColor
                                        : ''
                                }`}
                                onMouseEnter={getDistData}
