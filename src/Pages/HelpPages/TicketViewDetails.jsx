        ...
        <Breadcrumb.Item>Help</Breadcrumb.Item>
          ...
          <div className="d-flex justify-content-between py-5">
              <div className="ticket-info">
                  <p>Ticket Id:   <span>#2021-3453</span>
                  {props && props.status ==="Solved" ?
                  
                  <Tag color={'gold'} className="ticket-status">
                 Solved
                </Tag> :(props && props.status ==="Draft" ?<Tag color={'red'} className="ticket-status">
                 Solved
                </Tag>:<Tag color={'green'} className="ticket-status">
                 Solved
                </Tag>)
}
                  </p>
              ...
              <div className="ticket-action">
                  <Button btnClass="secondary" label="Open Ticket" shape="btn-square"/>
                  <DropDownComp label=""/>
              </div>
