        ...
        <Card className='ticket-card'>
            ...
            <CardBody>
                <div className='card-text'>
                    ...
                    <ReadMoreContent
                        more='Read More'
                        children='Hi, Lorem ipsum dolor sit amet, consectetur dipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Hi, Lorem ipsum dolor sit amet,  onsectetur adipiscing elit, sed do eiusmod tempor ncididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
                    />
                </div>
                <hr></hr>
