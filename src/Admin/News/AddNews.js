              ...
              >
                <Form onSubmit={formik.handleSubmit} isSubmitting>
                            ...
                            >
                             ...
                             News category
                              ...
                              <InputBox
                                ...
                                value={formik.values.newsTopic}
                              />

                              {formik.touched.newsTopic &&
                              formik.errors.newsTopic ? (
                                <small className="error-cls">
                                  {formik.errors.newsTopic}
                                </small>
                              ) : null}
                  ...
                  <Card className="aside p-4">
                    ...
                    <FormGroup className="form-row row mb-5">
                      <Label className="mb-2">Add News Details</Label>
                        <Col
                          className="form-group mb-5  mb-md-0"
                          md={12}
                         > 
                         ...
                         > 
                          <FormGroup className="form-row row mb-5">
                            ...
                            <p>Include all the information someone would need to understand your question</p>
                            <Col className="form-group" md={12}>
                            <InputBox
                                {...newsDes}
                                id="sessionTopic"
